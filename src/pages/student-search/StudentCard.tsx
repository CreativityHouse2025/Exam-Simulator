...
const StudentCard = ({ student, fromSearch }: StudentCardProps) => {
  ...
  return (
    ...
    >
      <InitialsAvatar firstName={student.firstName} lastName={student.lastName} className="size-10 text-sm" />
      ...
      <span className="shrink-0 text-end text-xs text-grey-800">
        ...
        <span className="block font-medium text-grey-900">{formatDate(student.createdAt)}</span>
      </span>
