...
const SignUpPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (firstNameFormatError) {
      firstName.setError(firstNameFormatError);
      return;
    }
    ...
    if (lastNameFormatError) {
      lastName.setError(lastNameFormatError);
      return;
    }
    ...
    try {
      ...
      await signUp(
        email.value,
        password.value,
        toTitleCase(firstName.value),
        toTitleCase(lastName.value),
      );
      setSuccess(true);
    } catch (err) {
