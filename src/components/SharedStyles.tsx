...
export const ModalOverlay: React.FC<React.ComponentProps<"div">> = ({ className, ...rest }) => (
  <div className={cn("fixed inset-0 z-5 flex items-center justify-center bg-black/50", className)} {...rest} />
)
...
export const Card: React.FC<React.ComponentProps<"div">> = ({ className, ...rest }) => (
  <div
    className={cn(
...
/** Centered logo image. */
export const PageLogo: React.FC<React.ComponentProps<"img">> = ({ className, ...rest }) => (
  ...
  <img className={cn("block mx-auto mb-3 size-15 md:size-20 md:mb-3.75", className)} {...rest} />
)

/** Page title heading with editorial serif font. */
export const PageTitle: React.FC<React.ComponentProps<"h1">> = ({ className, ...rest }) => (
  <h1
    className={cn("text-center font-sans text-xl md:text-2xl font-semibold text-tertiary mb-1", className)}
    {...rest}
  />
)

/** Subtitle text below the title. */
export const PageSubtitle: React.FC<React.ComponentProps<"p">> = ({ className, ...rest }) => (
  <p className={cn("text-center text-sm md:text-base text-grey-900 mb-5", className)} {...rest} />
)

/** Horizontal row for placing multiple FormGroups side by side. */
export const FormRow: React.FC<React.ComponentProps<"div">> = ({ className, ...rest }) => (
  <div className={cn("flex gap-2.5 *:flex-1 *:min-w-0", className)} {...rest} />
)

/** Flex column wrapper for label + input + error. */
export const FormGroup: React.FC<React.ComponentProps<"div">> = ({ className, ...rest }) => (
  <div className={cn("flex flex-col gap-1 mb-3.5", className)} {...rest} />
)

/** Field label. */
export const FormLabel: React.FC<React.ComponentProps<"label">> = ({ className, ...rest }) => (
  <label className={cn("text-sm md:text-base font-semibold text-black", className)} {...rest} />
)

/** Relative wrapper for positioning an icon inside an input. */
export const InputWrapper: React.FC<React.ComponentProps<"div">> = ({ className, ...rest }) => (
  ...
  ({ className, $hasError, $hasIcon, ...rest }, ref) => (
    <input
      ...
      className={cn(
        ...
        $hasError ? "focus:border-destructive" : "focus:border-primary focus:ring-3 focus:ring-primary/15",
...
export const PasswordInputWrapper: React.FC<React.ComponentProps<"div">> = ({ className, ...rest }) => (
  <div className={cn("relative flex items-center", className)} {...rest} />
)
...
export const FieldError: React.FC<React.ComponentProps<"span">> = ({ className, ...rest }) => (
  <span
    className={cn(
...
export const FormError: React.FC<React.ComponentProps<"div">> = ({ className, ...rest }) => (
  <div
    className={cn(
...
export const SubmitButton: React.FC<React.ComponentProps<"button">> = ({ className, ...rest }) => (
  <button
    className={cn(
...
export const NavLink: React.FC<React.ComponentProps<typeof Link>> = ({ className, ...rest }) => (
  <Link
    className={cn("text-secondary font-semibold no-underline transition-opacity duration-150 hover:opacity-80", className)}
    {...rest}
  />
)

/** Centered footer area for links, wraps on small screens. */
export const CardFooter: React.FC<React.ComponentProps<"div">> = ({ className, ...rest }) => (
  <div className={cn("flex flex-wrap justify-center gap-1 mt-4.5 text-sm text-center", className)} {...rest} />
)

/** Absolute-positioned back arrow button for card headers. */
export const BackButton: React.FC<React.ComponentProps<"button">> = ({ className, ...rest }) => (
  <button
    className={cn(
      "absolute top-3 left-3 bg-transparent cursor-pointer p-1 flex items-center justify-center",
 ...
 */
export const AuthSwitchBanner: React.FC<React.ComponentProps<"div">> = ({ className, ...rest }) => (
  <div
    className={cn(
