...
import { StudentSearchQuerySchema, type SearchStudentsResult } from "../../shared/schemas/student.schema.js";
...
export const GET = withErrorHandler(
  withAuth(
    withRole(["supervisor"], async (request, _authUser, cookieHeaders) => {
      ...
      const result: SearchStudentsResult = await searchStudentsByEmailOrName(validatedQuery);
